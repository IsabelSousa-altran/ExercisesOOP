...
namespace DataTime_Properties
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string s6 = d1.ToString("yyyy-MM-ddHH:mm:ss"); 
            string s7 = d1.ToString("yyyy-MM-ddHH:mm:ss.fff"); 
            ...
            DateTime x1 = new DateTime(2000, 10, 18);
            DateTime y = x.AddDays(7); 
            DateTime y1 = x.AddHours(2); 
            
            TimeSpan t = x.Subtract(x1);
        }
    }
}
